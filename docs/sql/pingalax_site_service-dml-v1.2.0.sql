...
CREATE TABLE `gu_login_log`
(
    `id`              int       NOT NULL AUTO_INCREMENT COMMENT '用户登录日志ID',
    `user_id`         int                                                            DEFAULT NULL COMMENT '用户ID',
    `oauth_id`        int                                                            DEFAULT NULL COMMENT '用户第三方登录信息ID',
    `username`        varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci   DEFAULT NULL COMMENT '用户登录名',
    `phone_area_code` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci    DEFAULT NULL COMMENT '国家区号',
    `phone`           varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci   DEFAULT NULL COMMENT '手机号码',
    `email`           varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci  DEFAULT NULL COMMENT '电子邮箱',
    `client_ip`       varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci   DEFAULT NULL COMMENT '用户登录时的网络IP',
    `client_type`     varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci   DEFAULT NULL COMMENT '登录终端类型:pc/ios/android/weixin/h5',
    `client_ua`       varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'http头中user_agent',
    `client_referer`  varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'http头中referer',
    `auth_type`       tinyint   NOT NULL COMMENT '授权方式：1用户名密码，2手机验证码，3OAtuh',
    `result`          tinyint                                                        DEFAULT NULL COMMENT '登录结果：1成功，2用户名密码错误，3手机验证码错误，4用户不存在',
    `result_desc`     varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci   DEFAULT NULL COMMENT '结果描述',
